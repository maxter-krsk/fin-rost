      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <ScrollArea className="h-[80vh] rounded-lg border border-gray-200 p-20 md:rounded-xl md:p-40">
          ...
          <p className="mb-20 font-extralight">
            ...
            по обеспечению безопасности персональных данных, предпринимаемые ИП Кирьяновой Ольгой
            Владимировной (далее — Оператор).
          </p>
          <p className="mb-20 font-extralight">
          ...
          <p className="mb-20 font-extralight">
            ...
            запроса;
            <br /> — публиковать или иным образом обеспечивать неограниченный доступ к настоящей
            ...
            <br /> — прекратить передачу (распространение, предоставление, доступ) персональных
          ...
          <p className="mb-20 font-extralight">
            ...
            <br /> — на отзыв согласия на обработку персональных данных, а также, на направление
            требования о прекращении обработки персональных данных;
            <br /> — обжаловать в уполномоченный орган по защите прав субъектов персональных данных
            или в судебном порядке неправомерные действия или бездействие Оператора при обработке
          ...
          <p className="mb-20 font-extralight">
            ...
            <br /> — сообщать Оператору об уточнении (обновлении, изменении) своих персональных
            данных.
          </p>
          <p className="mb-20 font-extralight">
          ...
          <ul className="mb-50">
            ...
            <li className="mb-20">
              ...
              <p className="font-extralight">
                уставные (учредительные) документы Оператора договоры, заключаемые между оператором
                и субъектом персональных данных{" "}
              </p>
            </li>
            <li className="mb-20">
              <h3 className="font-bold">Виды обработки персональных данных</h3>
              <p className="font-extralight">
