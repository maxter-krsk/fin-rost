...
export default function Footer() {
  ...
  return (
    <>
      <footer className="text-darkBlue desk:pt-30 desk:pb-60 xs:block relative hidden bg-white pt-24 pb-68">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-[1fr_auto_auto] gap-20">
            <div className="flex flex-col gap-36">
              ...
              <div className="text-12 md:text-14 desk:text-16 font-onest mr-12 flex flex-col gap-10 font-thin">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-86 gap-x-60">
              <section
      ...
      <footer className="text-darkBlue desk:pt-30 desk:pb-60 xs:hidden relative block bg-white pt-40 pb-40">
        <div className="container">
          <Image
            className="mb-30 h-48 w-66"
            src="/icons/logos/logo-dark.svg"
            alt="Логотип компании"
            width={66}
            height={49}
          ...
          <div>
            <div className="flex flex-col gap-20">
              ...
              <Button className="flex w-full max-w-none justify-center" href="#form" variant="dark">
                Записаться
              </Button>
              <address className="text-14 font-onest flex flex-col gap-10 font-extralight not-italic">
                <p>ИП Кирьянова О.В. </p>
                <p>ИНН 246517268045</p>
                <p>ОГРНИП 318246800069120 </p>
                <p>Красноярский край, г. Красноярск </p>
              ...
              <div className="text-12 md:text-14 desk:text-16 font-onest mr-12 flex flex-col gap-10 font-thin">
                <p>Работаем на территории России и стран СНГ</p>
                <Link className="nav-link w-auto" href="/privacy-policy">
                  Политика конфиденциальности
                </Link>
              </div>
